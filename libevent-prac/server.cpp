...
static void dumpRequest_cb(struct evhttp_request* req, void* arg)
{
    const char *cmdtype;
...
static void sendDocument_cb(struct evhttp_request* req, void* arg)
{
...
int main(int argc, char** argv)
{
    ...
    evhttp_set_cb(http, "/dump", dumpRequest_cb, NULL);

    evhttp_set_gencb(http, sendDocument_cb, argv[1]);
