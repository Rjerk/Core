...
void quick_sort(FwdIt first, FwdIt last, Compare cmp = Compare{})
{
    ...
    auto const middle1 = std::partition(first, last, [=](value_type_t<FwdIt> const& elem){ return cmp(elem, pivot); });
    auto const middle2 = std::partition(middle1, last, [=](value_type_t<FwdIt> const& elem){ return !cmp(pivot, elem); });
